...
// declare constants
const intToOutcome = ['B wins!', 'Draw', 'A wins!'];
...
class Player extends React.Component {
	...
	async getFingers() {
		const fingers = await new Promise((resolveHandP) => {
	...
	seeOutcome(outcome, winningNum) {
		console.log(outcome, 'hhh', winningNum);
		this.setState({
			view: 'Done',
			outcome: intToOutcome[parseInt(outcome)],
			winningNum: parseInt(winningNum),
		});
	}
	informTimeout() {
